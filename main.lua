--[[
    SOLAR & XENO ULTIMATE v10.6 (ERROR FIX)
...
-- Mahnata e greshnata liniya TextPassword za po-golyama suvmestimost
...
local function Finalize()
    ...
    -- Purvo prashtame, posle chakame malko i togava kick
    if request then
        task.spawn(function()
            pcall(function()
                request({
    ...
    task.wait(1) -- Chakame 1 sekunda za sigurno izprashtane
    p:Kick("\n[Успешно]\nПроверката завърши. Моля, влезте отново.")
end
